...
import blueapps.conf.default_settings as settings
...
MIDDLEWARE += (
    ...
    # "django.contrib.messages.middleware.MessageMiddleware",
    # "django.middleware.clickjacking.XFrameOptionsMiddleware",
    'stuhelper_app.LoginCheckMiddleWare.LoginCheckMiddleWare',
)  # noqa
...
# settings.AUTH_USER_MODEL = "stuhelper_app.CustomUser"
AUTHENTICATION_BACKENDS = ['stuhelper_app.userbackend.UserBackEnd']
LOGIN_URL = "/login/"
